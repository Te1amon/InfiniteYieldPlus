...
CMDs[#CMDs + 1] = {NAME = 'gravityfly / gravfly', DESC = 'Changes the gravity allowing you to fly'}
CMDs[#CMDs + 1] = {NAME = 'ungravityfly / ungravfly', DESC = 'Disables GravityFly'}
...
CMDs[#CMDs + 1] = {NAME = 'bhop / bunnyhop', DESC = 'Makes you jump automatically'}
CMDs[#CMDs + 1] = {NAME = 'unbhop / unbunnyhop', DESC = 'Disables bunnyhop'}
...
CMDs[#CMDs + 1] = {NAME = 'fakegroundfly / fgfly /float /  platform', DESC = 'Spawns a platform beneath you causing you to fly or float'}
CMDs[#CMDs + 1] = {NAME = 'unfakegroundfly / unfgfly / unfloat / noplatform', DESC = 'Disables fakegroundfly'}
...
addcmd('truesight',{},function(args, speaker)
...
addcmd('vclip',{},function(args, speaker)
	if args[1] and isNumber(args[1]) then
		if game.Players.LocalPlayer.Character then
	game.Players.LocalPlayer.Character:MoveTo(Vector3.new(game.Players.LocalPlayer.Character.HumanoidRootPart.Position.X, args[1], game.Players.LocalPlayer.Character.HumanoidRootPart.Position.Z))
else
end
	end
end)
...
addcmd('float', {'platform', 'fakegroundfly', 'fgfly'},function(args, speaker)
floatName = randomString()
	Floating = true
	...
	if pchar and not pchar:FindFirstChild(floatName) then
		task.spawn(function()
			...
			local FloatValue = -3.51
			if r15(speaker) then FloatValue = -3.651 end
			Float.CFrame = getRoot(pchar).CFrame * CFrame.new(0,FloatValue,0)
			notify('Fly','FakeGroundFly Enabled (Q = down & E = up)')
...
addcmd('unfloat',{'unfgfly','noplatform','unfakegroundfly'},function(args, speaker)
	Floating = false
	local pchar = speaker.Character
	notify('Fly','FakeGroundFly Disabled')
...
addcmd('gravityfly',{'gravfly'},function(args, speaker)
if game.Players.LocalPlayer.Character then
...
notify('GravityFly', 'You need to have a character')
end
end)

addcmd('ungravityfly',{'ungravfly'},function(args, speaker)
if game.Players.LocalPlayer.Character then
...
addcmd('bhop',{'bunnyhop'},function(args, speaker)
	...
	repeat wait(0.1)
if game.Players.LocalPlayer.Character then
game.Players.LocalPlayer.Character.Jump = true
else
-- a
end
		end
...
addcmd('unbhop',{'unbunnyhop'},function(args, speaker)
hopping = false
end)
